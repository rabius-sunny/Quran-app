      ...
      >
        ...
        <div className='relative'>
          ...
          <Input
            ...
            className='pl-12 pr-12 h-14 text-lg rounded-2xl border-0 bg-white/50 dark:bg-black/20 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] focus-visible:ring-2 focus-visible:ring-emerald-500/30 placeholder:text-muted-foreground/60 transition-all duration-300'
            autoFocus
          />
          {searchQuery && (
            <Button
            ...
            <div className='relative z-10 space-y-6'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground max-w-md mx-auto leading-relaxed'>
                  Type in the search box above to find surahs by name, number,
                  translation, or revelation place
                </p>
              </div>
