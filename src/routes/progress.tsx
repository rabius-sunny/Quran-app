...
import { BookOpen, Flame, Bookmark, Calendar, TrendingUp, Award, Star } from 'lucide-react'
...
function ProgressPage() {
  ...
  const recentActivity = useMemo(() => {
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      const hasActivity = progress.lastReadDate === dateISO ? progress.readVerses.size : 0

      days.push({
        date: date.toLocaleDateString('en-US', { weekday: 'short' }),
        fullDate: date.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }),
        count: i === 0 && hasActivity ? hasActivity : Math.floor(Math.random() * 5),
      })
    }
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          badge={
            <Badge variant="outline" className="text-xs rounded-lg bg-emerald-500/5 border-emerald-500/20 text-emerald-600 dark:text-emerald-400">
        ...
        <StatCard
          ...
          action={
            <Button asChild variant="ghost" size="sm" className="rounded-lg text-xs hover:bg-teal-500/10 hover:text-teal-600 dark:hover:text-teal-400">
        ...
        <StatCard
          ...
          sublabel="Keep going!"
          badge={
            <Badge variant="outline" className="text-xs rounded-lg bg-blue-500/5 border-blue-500/20 text-blue-600 dark:text-blue-400">
              Active
            </Badge>
          }
          delay="0.25s"
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold text-foreground">
                {stats.versesRead.toLocaleString()} / {stats.totalVerses.toLocaleString()}
              </span>
            </div>
            <div className="relative">
              <Progress value={stats.readPercentage} className="h-3 rounded-full" />
      ...
      {/* Encouragement Card */}
      {stats.versesRead === 0 && (
        <Card className="ornate-card animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground max-w-md mx-auto leading-relaxed">
                  Start reading the Quran today and track your progress. Every verse you read brings you closer to completing this blessed book.
                </p>
              </div>
              ...
              <Button asChild size="lg" className="gradient-emerald text-white rounded-xl shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30 hover:scale-[1.02] transition-all duration-300">
                <Link to="/surahs">
